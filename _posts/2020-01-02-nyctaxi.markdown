...
representing one calendar day.  From there, a 30 day raised cosine
filter is applied to smooth the curve into a month-like timescale.
...
program with care.  We use gnuplot, and it handles this file pretty
well.
